...
const ContentDetails = ({batch}: { batch: any }) => {
    ...
    const {data, isLoading, refetch} = useBatchContents({
        ...
        contentType: TAB_ITEMS[batch.contentType as BatchType]?.items[currentIndex].key,
    ...
    return <div className="flex flex-col gap-6">
        <TabHeader
            ...
            items={TAB_ITEMS[batch.contentType as BatchType].items}
...
const Content = () => {
    ...
    return (
        <ContentDetails batch={batchDetails}/>
    )
}
