...
function GlobalEducation() {
  return (
    <div className=" sm:py-[40px] py-[24px] max-w-6xl mx-auto  ">
      <div className=" bg-[#FEF6F7] sm:p-[48px] p-[16px] rounded-2xl ">
        <div className="text-center sm:mb-[40px] mb-[16px]">
          ...
          <h2 className="text-[#DA1F3D] sm:text-[32px] text-[20px] font-bold md:leading-[48px] leading-[30px]">
            Global Education
          </h2>
          <p className="sm:text-[18px] text-[14px] leading-[22px] md:leading-[28px] mt-[9px]">
            A Look Into PW Unigo's Versatile Offerings for Aspiring Students
          </p>
        </div>

        <div className="sm:flex sm:text-[20px] text-[16px] font-bold sm:justify-evenly items-center m-auto">
          <div>
