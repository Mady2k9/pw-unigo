...
<div className='relative'>
  ...
  <div className="absolute top-[20%] md:bottom-[10px] lg:top-[3%] xl:top-[15%] 2xl:top-[20%] font-[700] justify-center text-center w-full">
    <div className='lg:w-[824px] md:w-[500px] w-[328px] m-auto'>
  <p className='lg:text-[64px] md:text-[30px] text-[32px] font-[600] leading-[48px] sm:leading-[24px] lg:leading-[80px]'>Study Abroad from</p>
    <p className='lg:text-[64px] sm:text-[28px] text-[32px] font-[600] leading-[48px] lg:leading-[80px] text-[#DA1F3D]'>Top Universities</p>
