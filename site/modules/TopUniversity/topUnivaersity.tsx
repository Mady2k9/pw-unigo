    ...
    <>
      <div className="relative">
        ...
        <img
          ...
          alt="Top banner"
        />
        <div className="absolute left-0 w-full top-0 h-full grid content-center">
          <div className="text-center">
            <div className="xl:w-[824px] w-[310px] sm:w-[700px] m-auto">
              ...
              <p className="font-[600] mb-[22px] sm:mb-[10px] text-[16px] sm:text-[16px] xl:text-[20px] leading-[24px] sm:leading-[26px] lg:leading-[30px]">
                ...
                support you every step of the way. Let's begin this
                extraordinary journey together. Here, we blend academic
