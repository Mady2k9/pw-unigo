              ...
              <span className="text-white font-bold text-[12px] uppercase bg-[#2E2676] p-1 px-1.5 rounded-md w-fit">
                What you get
                        ...
                        <div>
                            <Image
                                src={
                                    batchData ? (batchData.previewImage.baseUrl + batchData.previewImage.key) : placeholderImage
                                }
                                objectFit={'contain'}
                                width={112}
                                height={112}
                  ...
                  <span className="text-white">
                    Live Lectures | Practice Sheets | Doubt Solving
                        ...
                        <div className="max-w-full lg:max-w-[140px] h-[134px] lg:h-[80px] ">
                            <img
                                src={
                                    batchData ? (batchData?.previewImage?.baseUrl +
                                        batchData?.previewImage?.key) : placeholderImage
                                }
