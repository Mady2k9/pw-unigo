...
(function (global, factory) {
  ...
  videojs__default['default'].getComponent('ControlBar').prototype.options_.children = ['PlayToggle', 'CustomControlSpacer', 'VolumePanel', 'CurrentTimeDisplay', 'TimeDivider', 'DurationDisplay', 'SkipButtons', 'ProgressControl', 'CustomControlSpacer', 'SettingMenuButton', 'FullscreenToggle'];
  videojs__default['default'].hook('setup', function (vjsPlayer) {
